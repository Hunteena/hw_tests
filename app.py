...
def move_doc_to_shelf():
    ...
    print(f'Документ номер "{user_doc_number}"',
          f'был перемещен на полку номер "{user_shelf_number}"')
